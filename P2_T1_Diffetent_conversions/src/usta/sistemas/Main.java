...
public class Main {
	...
	DATE : 13/04/2020
	DESCRIPTION: This program convert °C to °F|°F to °C|°F to °K|°K to °C|°C to °K|
	 */
    ...
    public static void f_menu() {
        ...
        System.out.println("-----------------------------");
        System.out.println("--------CovertSoft-----------");
        System.out.println("-Version: 1.0-- 13/04/2020---");
        System.out.println("-Created by: Angel Manuel----");
        System.out.println("-----------------------------");
    ...
    public static int f_kind_grades() {
        ...
        if (opt == 1 || opt == 2 || opt == 3) {
            ...
            System.err.println("ERROR:Finishing software because The class does not exist ");
            opt = 0;
        }
